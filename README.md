...
To update the database use this command from the Web project folder (replace `FormDesignerAPI` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FormDesignerAPI.Infrastructure/FormDesignerAPI.Infrastructure.csproj -s FormDesignerAPI.Web.csproj
```
