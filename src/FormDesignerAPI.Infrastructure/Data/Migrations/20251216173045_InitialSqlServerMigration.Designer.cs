...
namespace FormDesignerAPI.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251216173045_InitialSqlServerMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FormDesignerAPI.Core.FormContext.Aggregates.Form", b =>
                {
                    b.OwnsOne("FormDesignerAPI.Core.FormContext.ValueObjects.FormDefinition", "Definition", b1 =>
                        {
            ...
            modelBuilder.Entity("FormDesignerAPI.Core.FormContext.Aggregates.FormRevision", b =>
                {
                    ...
                    b.OwnsOne("FormDesignerAPI.Core.FormContext.ValueObjects.FormDefinition", "Definition", b1 =>
                        {
                            b1.Property<Guid>("FormRevisionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("FormRevisionId");

                            b1.ToTable("FormRevisions");
