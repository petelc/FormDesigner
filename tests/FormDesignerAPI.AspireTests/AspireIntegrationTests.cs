...
public class AspireIntegrationTests
{
    ...
    [Fact]
    public async Task GetWebResourceContributersReturnsOkStatusCode()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetWebResourceFormssReturnsOkStatusCode()
    {
        // Arrange
        var builder = await DistributedApplicationTestingBuilder
            .CreateAsync<Projects.FormDesignerAPI_AspireHost>();
        ...
        var response = await httpClient.GetAsync("/Forms", cts.Token);
